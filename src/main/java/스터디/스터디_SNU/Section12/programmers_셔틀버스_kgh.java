 ...
 *
 * (6) 버스 정원이 모두 가득찼을 경우, 운행을 종료시키고 마지막지점까지 도달하여 콘은 마지막 프렌즈 도착시간 이전타임 보다 1분 일찍 오면 콘이 오는시간
 * (7) 아직 더 탈인원이 있다면 다음 운행버스 호출
 * (8) 정답은 hh:mm 형식이므로 convertToString 함수 호출하여 정답 반환
 * 3.시간복잡도
 * O(N^2)
 */
